...
type ParserCore interface {
	...
	ParseDeployment(ctx context.Context, ignoreParameter bool) (*Deployment, error)
	ValidateTile(ctx context.Context, tile *Tile) error
	ValidateDeployment(ctx context.Context, deployment *Deployment, ignoreParameter bool) error
	CheckParameter(ctx context.Context, deployment *Deployment, ignoreParameter bool) error
}
...
func (d *Data) ParseDeployment(ctx context.Context, ignoreParameter bool) (*Deployment, error) {
	...
	return &deployment, d.ValidateDeployment(ctx, &deployment, ignoreParameter)
}
...
func (d *Data) ValidateDeployment(ctx context.Context, deployment *Deployment, ignoreParameter bool) error {
	// Validate json schema
	...
	return d.CheckParameter(ctx, deployment, ignoreParameter)
}

func (d *Data) CheckParameter(ctx context.Context, deployment *Deployment, ignoreParameter bool) error {
	if ignoreParameter {
		return nil
	}
	parameters := ""
